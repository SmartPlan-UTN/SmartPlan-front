...
- Tipo de aplicativo y diagrama
- Componentes y tecnologías
- Comunicación entre componentes
- Procesamiento asíncrono (qué va por cola y por qué)
- Entornos (desarrollo y producción)
- Configuración por entorno (variables de entorno)
- Qué está implementado vs. solo documentado
...
Frontend, backend y PostgreSQL/TypeORM ya están en el código. **RabbitMQ,
workers, Amazon S3 y la integración con OpenAI están en este diagrama porque
están definidos en la documentación del proyecto, pero todavía no tienen
dependencias ni módulos escritos.** Antes de implementar cualquiera de estos,
confirmá en `SEGUIMIENTO.md` → Pendientes conocidos que la decisión sigue vigente.
