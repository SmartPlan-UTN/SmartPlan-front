...
|---|---|---:|---:|
| **Álvaro Ariza** | Front-End · UX/UI | 12 | 39 |
| **Luciano Marquesini** | Front-End | 14 | 42 |
| **Ramiro Martínez** | Full Stack · DBA | 9 | 54 |
| **Bautista Alós** | Full Stack · IA | 13 | 63 |
| **Matías Zarandón** | Full Stack · QA · Líder | 14 | 77 |
| **Valentín Mathey** | Back-End · DevOps · Scrum Master | 9 | 54 |
| | | **71** | **329** |
...
**El reparto va de 39 a 77 puntos, con un promedio de 54.** Está armado
por módulos completos: cada persona se lleva módulos enteros en vez de issues
sueltos, para tener contexto y no saltar entre partes del sistema.

La contrapartida es que no queda parejo en carga. Matías concentra los issues
más grandes del tablero —la API de administración, la de colección y el panel
REP-01— y queda bastante por encima del promedio; Álvaro y Luciano, por debajo,
aunque cargan el design system y el cliente HTTP, que no tienen issue propio.

**Revisarlo en el refinamiento del sprint 0.** Si el desbalance molesta, lo más
simple es mover el módulo de colección (17 puntos) de Matías a Luciano.

### Asignación en GitHub

| Persona | Usuario | Estado |
|---|---|---|
| Álvaro Ariza | — | 12 **pendientes** |
| Luciano Marquesini | — | 14 **pendientes** |
| Ramiro Martínez | `Rami195` | 9 asignados |
| Bautista Alós | `BautistaAlosMartorell` | 13 asignados |
| Matías Zarandón | `TuteSeta` | 14 asignados |
| Valentín Mathey | `valentinmathey` | 9 asignados |

**Quedan 26 issues sin asignar.** Álvaro y Luciano todavía no son miembros
de la organización, y GitHub solo permite asignar a quien tenga acceso al
repositorio. Invitalos en `github.com/orgs/SmartPlan-UTN/people` y después
asignales los issues que figuran en sus tablas.
...
### Álvaro Ariza
*Front-End · UX/UI* — 12 issues, 39 puntos
...
### Bautista Alós
*Full Stack · IA* — 13 issues, 63 puntos
...
### Matías Zarandón
*Full Stack · QA · Líder* — 14 issues, 77 puntos
...
### Valentín Mathey
*Back-End · DevOps · Scrum Master* — 9 issues, 54 puntos
...
| Matías | CU55, CU57 — moderación y administración de usuarios |
...
| Persona | Trabajo |
|---|---|
| Bautista | CU17 a CU23 + API de recomendación + CU51, CU52 |
| Luciano | CU15, CU39 a CU43 — favoritos |
| Ramiro | API de favoritos |
| Álvaro | CU44 a CU47 — valoraciones |
| Valentín | API de valoraciones |
| Matías | API de colección |

### Sprint 5 — Colección y administración

Sprint cargado para Matías: entra el módulo de colección entero más la API de administración.

| Persona | Trabajo |
|---|---|
| Matías | CU32 a CU38 — colecciones · API de administración · CU60 |
| Valentín | CU54, CU56, CU59, CU61, CU62 — permisos, roles, auditoría |
| Ramiro | Consultas agregadas para métricas |
| Bautista | Ajuste del motor según historial |
| Álvaro | Estados vacíos, de error y accesibilidad |
| Luciano | Pulido de flujos |

### Sprint 6 — Reportes e integración

| Persona | Trabajo |
|---|---|
| Matías | CU58 — panel de control REP-01 · tests e2e |
| Valentín | Despliegue en Railway y Vercel |
| Ramiro | Optimización de consultas |
| Bautista | Afinado del motor de recomendación |
| Álvaro | Pulido visual y revisión del design system |
