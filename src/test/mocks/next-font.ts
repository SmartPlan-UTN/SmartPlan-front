 ...
 * importe —aunque sea de forma indirecta— un archivo que declare una fuente.
 *
 ...
 * con nombre y no alcanza con un default.
 */
...
export default function localFont(options: LocalFontOptions = {}): LocalFont {
  return {
    className: "mock-font",
    // Se devuelve el nombre de la variable CSS pedida —y no una clase generada—
