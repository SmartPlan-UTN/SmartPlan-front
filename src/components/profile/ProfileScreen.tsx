 ...
 * card sharing this screen — see `SecurityScreen`'s doc comment. Its
 * delete-account "danger zone" is the same prototype screen too (CU7) — a
 * separate ticket, not built here.
 *
