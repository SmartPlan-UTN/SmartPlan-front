 ...
 * enforces just `MIN_PASSWORD_LENGTH` (12-128, no complexity rule), the
 ...
 * real, enforced rule: the actual contract is 12-128 characters with no
 * complexity requirement, so the length label uses `MIN_PASSWORD_LENGTH`
 * instead of the mockup's literal 8, and `validate()` below only checks
 * length. The other two rows are informational, same non-normative
